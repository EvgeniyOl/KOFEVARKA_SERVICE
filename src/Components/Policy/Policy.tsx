...
const Policy: React.FC = () => {
  return (
    <div className="policyWrapper">
      ...
      <div className="policy_title">1. Общие положения</div>
      <div className="policy_text">
        ...
        безопасности персональных данных, предпринимаемые ИП Жердев Дмитрий
        Владимирович (далее – Оператор).
      </div>
      ...
      <div className="policy_list">
        <ul>
          ...
          <li>
            ...
            является субъект персональных данных. <br /> Обрабатываемые
      ...
      <div className="policy_title">7. Цели обработки персональных данных</div>
      <div className="policy_list">
        <ul>
          <li>
            7.1. Цель обработки персональных данных Пользователя: <br /> –
            информирование Пользователя посредством отправки электронных писем;
            <br />– заключение, исполнение и прекращение гражданско-правовых
            договоров.
          </li>
          <li>
            ...
            электронной почты kofeinik55@gmail.com с пометкой «Отказ от
      ...
      <div className="policy_list">
        <ul>
          <li>
            ...
            являются: <br /> – договоры, заключаемые между оператором и
            субъектом персональных данных;
            <br /> – федеральные законы, иные нормативно-правовые акты в сфере
          ...
          <li>
            ...
            https://kofevarkaservice.ru/ или направленные Оператору посредством
      ...
      <div className="policy_list">
        <ul>
          ...
          <li>
            ...
            Оператора kofeinik55@gmail.com с пометкой «Актуализация персональных
            данных».
          </li>
          <li>
            ...
            kofeinik55@gmail.com с пометкой «Отзыв согласия на обработку
            персональных данных».
          </li>
          <li>
      ...
      <div className="policy_title">14. Заключительные положения</div>
      <div className="policy_list">
        <ul>
          <li>
            ...
            к Оператору с помощью электронной почты kofeinik55@gmail.com.
          </li>
          <li>
          ...
          <li>
            ...
            сети Интернет по адресу https://kofevarkaservice.ru/policy.
          </li>
        </ul>
      </div>
    </div>
